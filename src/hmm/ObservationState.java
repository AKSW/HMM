...
public class ObservationState {
	...
	private Hashtable<List<String>, List<ResourceInfo>> observedMap = 
			new Hashtable<List<String>, List<ResourceInfo>>();

	private List<List<String>> observationList = new ArrayList();
	...
	public void buildStateSpace(List<String> keywordList,boolean isKeyPhrases){

		System.out.println( " hello  to state space ");
//		if(isKeyPhrases)
//		{
//			List<String> newKeywordList = new LinkedList<String>();
//			for(String keyword : keywordList) newKeywordList.addAll(Arrays.asList(keyword.split("\\s")));
...
//		}
		...
		for (int i=0 ; i< observationList.size(); i++)
		{
			...
			List<String> Segment =observationList.get(i);
	...
	//#############     ##############
	//################################
	public void buildObservationStateForSegmentedQuery(Map<List<String>,List<ResourceInfo>> segmentToResources)
	{
		observedMap.clear();
		observedMap.putAll(segmentToResources);
		observationList.clear();
		observationList.addAll(segmentToResources.keySet());
//		//List<String> segmentAsList = Arrays.asList(segment.split("\\s"));					
//		for(List<String> segment: segmentToURIs.keySet())
//		{	
//			List<ResourceInfo> resourceInfos = new LinkedList<ResourceInfo>();
////			for(ResourceInfo uri: segmentToURIs.get(segment))
////			{
////				ResourceInfo info = new ResourceInfo();		
////				info.setUri(uri);
////				resourceInfos.add(info);
////			}
//			observedMap.put(segment, segmentToURIs.get(segment));			
//			observationList.add(segment);				
//		}
	}

	public void buildModerateObservationState(List<String> keywordQuery)
	{
