...
public class Constants {
	...
	public static final  String[] StopWords = {"I" , "a", "about", "and", "an", "are", "as", "at", "be","been", "by", "me", "us", "your", "were", "also", "its",
			 "com", "for", "from", "how", "in", "is", "it", "of", "on", "or", "that",
			 "the", "this", "that", "these","those" , "did","many","there" ,"much", "does", "Mr.", "do","have", "has", "which", "to", "was", "were", "what", "when", "where", "who", "will", "with", "www","give" , "all","more","than" };
	
	
	public static final String DefaultGraphString ="http://live.dbpedia.org"; 
	
	public static final int MaximumDistance	= 100;
	
	public static final String urlsever ="http://live.dbpedia.org/sparql";//"http://live.dbpedia.org/sparql";//"http://dbpedia.org/sparql";//"http://live.dbpedia.org/sparql";////"http://139.18.2.96:8910/sparql";//"http://139.18.2.96:8910/sparql";// ;//;   //"http://live.dbpedia.org/sparql";// "http://139.18.2.96:8910/sparql";
	
	public static final String SPARQLEndPoint="http://dbpedia.org/sparql";//"http://live.dbpedia.org/sparql";//"http://dbpedia.org/sparql";//"http://live.dbpedia.org/sparql";//"http://dbpedia.org/sparql";//"//"http://139.18.2.96:8910/sparql"; //
	...
	//public static final File ontologyAddress = new File("dbpedia_36.owl");
	//public static final File ontologyAddress = new File("dbpedia_3.6.owl");
